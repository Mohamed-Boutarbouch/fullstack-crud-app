  ...
  return (
    <>
      ...
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <h1 className="px-5 pb-5 text-6xl font-semibold tracking-tight text-gray-900 dark:text-white">
          {product.data.name}
        </h1>
        {product.data.image ? <img src={product.data.image} alt={product.data.name} /> : ''}
        <div className="px-5 pb-5">
          <h5 className="text-lg font-semibold tracking-tight text-gray-900 dark:text-slate-300">
